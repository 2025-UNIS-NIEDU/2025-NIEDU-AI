...
def generate_term_card():
    ...
    def fetch_definition(term):
        ...
        best_item = max(items, key=lambda x: len(x.get("snippet", "")) if x.get("snippet") else 0)
    ...
    def complete_snippet(term, snippet):
        ...
        1️. 주어진 문장을 한글로만 구성된 완전한 문장으로 자연스럽게 이어서 완성하세요.
        2️. 의미가 불명확하거나 문법적으로 끊긴 경우 '{term}'의 정의를 새롭게 한 문장으로 재작성하세요.
